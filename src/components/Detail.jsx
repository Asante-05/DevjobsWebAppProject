    ...
    <>
      <div>
        ...
        <div className="flex justify-center items-center relative mt-10">
          <div className={classNames(" mt-1 w-11/12  p-10 bg-white rounded-bl-md flex flex-col justify-center gap-5 items-center ", {"bg-veryDarkBlue" : isSelected})}>
            <div className=" w-11/12 ">
              <div className="space-y-2">
                ...
                <div className={classNames("font-extrabold  text-[20px] text-black", {"text-white" : isSelected})}>
                  <h1>{item.position}</h1>
                </div>
            ...
            <div className="mt-5">
              <div className={classNames("text-black", {"text-grey" : isSelected})}>
                <div>{item.description}</div>
              </div>

              <div className="justify space-y-10">
                <div className="mt-10 font-bold text-xl">Requirements</div>
                <div className={classNames("text-black font-normal text-base", {"text-grey" : isSelected})}>
