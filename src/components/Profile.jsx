...
const Profile = ({ id, logo, company, postedAt, position, contract, location }) => {
  ...
  return (
    <>
      <div className={classNames(" p-10 rounded-lg  min-h-[147px] min-w-[350px]   relative ", { "bg-veryDarkBlue" : isSelected })}>
      ...
      <div className={classNames("min-h-[147px] min-w-286  ", { "bg-veryDarkBlue" : isSelected})}>
          ...
          <div className={classNames("font-extrabold mt-3 text-[20px] text-white", {"text- hover:text-grey" : isSelected})}>
            <h1>{position}</h1>
          </div>
